...
.PHONY: test test-packing test-streaktracker test-vpoints test-splitter test-workflows build build-packing build-streaktracker prepare-site clean

test: test-packing test-streaktracker test-vpoints test-splitter test-workflows ## Run all tests across projects.
...
test-splitter:
	node --test splitter/app.test.js
