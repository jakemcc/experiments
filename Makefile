...
.PHONY: test test-packing test-streaktracker test-vpoints test-spliter test-workflows build build-packing build-streaktracker prepare-site clean

test: test-packing test-streaktracker test-vpoints test-spliter test-workflows ## Run all tests across projects.
...
prepare-site:
	mkdir -p site/StreakTracker site/Counter site/VPoints site/Packing site/99-bottles site/spliter
	...
	cp spliter/index.html spliter/app.js site/spliter/
